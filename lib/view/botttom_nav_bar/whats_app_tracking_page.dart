...
final Uri _url = Uri.parse('https://www.instagram.com/gyrosfarm/');
final Uri _url2 = Uri.parse('https://www.facebook.com/gyrosfarm');
final Uri _url3 = Uri.parse('https://twitter.com/gyros_farm');
final Uri _url4 = Uri.parse('https://www.youtube.com/@gyros.farmindia');
final Uri _url5 =
    Uri.parse('https://www.linkedin.com/company/gyros-farm/about/');
final Uri _url6 = Uri.parse('https://gyros.farm/');
...
class WhatsAppTrackOrder extends StatelessWidget {
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: Image.asset(
                                      'lib/assets/asset/youtube-music.png',
                                      height: 5.h,
                                      width: 10.w,
                                      color: Colors.white,
                                    ),
                                  ...
                                  InkWell(
                                    ...
                                    child: Image.asset(
                                      'lib/assets/asset/linkedin103.png',
                                      height: 5.h,
                                      width: 10.w,
                                      color: Colors.white,
                                    ),
  ...
  _launchWhatsapp() async {
    var whatsapp = "+919810015975";
    var whatsappAndroid =
        Uri.parse("whatsapp://send?phone=$whatsapp&text=Welcome To Gyros.");
